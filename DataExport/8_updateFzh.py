...
if __name__ == "__main__":
    ...
    dissolvepath = 'dissolvepath_8'
    outputxzkpath = 'outputxzkpath_8'

    arcpy.AddMessage("8_融合得到新分组号")
    dissolveGetFzh(xzkPath,dissolvepath,outputxzkpath)
        
    arcpy.AddMessage("8_补充更新分组号")
    updateFzh(outputxzkpath)

    arcpy.SetParameterAsText(2,outputxzkpath)
    arcpy.AddMessage("8_结束更新范围")